    ...
    <div class="contents">
        <div class="row search-form reg-imm">
            <div class="push-max-width container-fluid div-text-top">
                <div class="div-before"></div><div class="text-after">緊急お知らせ新規登録画面</div>
            </div>
            <div class="search-input push-search-max-width">
                ...
                <div class="row">
                    <div class="parent-btn">
                        ...
                        <a href="PushManagement_ConfirmImmediately.html"><button class=" btn-warning col-md-offset-2 col-md-5">確認する</button></a>
                    </div>
                </div>
            </div>
        </div>
